...
export const OBSTACLE_TYPE_BRICK: string = 'brick';
export const OBSTACLE_TYPE_METAL: string = 'metal';
export const OBSTACLE_TYPE_WATER: string = 'water';
export const OBSTACLE_TYPE_FOREST: string = 'forest';
export const OBSTACLE_TYPE_TRANSPARENT: string = 'transparent';